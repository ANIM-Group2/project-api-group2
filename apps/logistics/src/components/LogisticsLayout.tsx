...
//   Truck, Bell, Menu, Moon, Sun, ChevronDown, User, LogOut,
// } from 'lucide-react';

// interface LogisticsLayoutProps { children: React.ReactNode }

// const pageTitles: Record<string, string> = {
//   '/dashboard': 'Dashboard', '/stock': 'Stock', '/reservations': 'Reservations',
//   '/shipments': 'Shipments', '/alerts': 'Alerts', '/profile': 'Profile & Settings',
// };
...
//   const displayName = user?.firstName && user?.lastName ? `${user.firstName} ${user.lastName}` : 'Claire Dupont';
      ...
      <div className="flex flex-1 flex-col">
        <header className="flex h-16 items-center justify-between border-b border-border/50 bg-card px-4 lg:px-6">
          ...
          <div className="flex items-center gap-2">
            ...
            <NotificationBell role="logistics" />
            <DropdownMenu>
              <DropdownMenuTrigger asChild>
                <Button variant="ghost" className="flex items-center gap-2 px-2">
                  <Avatar className="h-8 w-8">
