...
export function LogisticsLayout({ children, activeAlertCount = 4 }: LogisticsLayoutProps) {
  ...
  const navItems = [
    ...
    { href: '/alerts', label: 'Alerts', icon: Bell, badge: activeAlertCount > 0 ? activeAlertCount : undefined },
  ];
    ...
    <div className="flex h-full flex-col">
      ...
      <div className="border-t border-border/50 p-4">
        <div className="flex items-center gap-3 rounded-lg bg-muted/50 p-3">
          ...
          <div className="flex flex-col">
            <span className="text-sm font-medium text-foreground">Claire Dupont</span>
            <span className="text-xs text-muted-foreground">Logistics Manager — Lyon site</span>
          </div>
        </div>
      </div>
    </div>
